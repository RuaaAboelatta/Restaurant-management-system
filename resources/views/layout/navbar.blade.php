            ...
            @if(Auth::user()->role === 'admin')
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="nav-link d-inline">Dashboard</a>
                    </li>
                    <li class="nav-item mx-3">
                        <i class="fa-solid fa-clock"></i>
                        <a href="{{ route('admin.bookings') }}" class="nav-link d-inline">Bookings</a>
                    </li>
                    <li class="nav-item">
                        <i class="fa-solid fa-dollar-sign"></i>
                        <a href="{{ route('admin.orders') }}" class="nav-link d-inline">Orders</a>
                    </li>
                </ul>
            @endif
